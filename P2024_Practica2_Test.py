...
from P2024_Practica2_Skeleton import *
...
class Test_2_3_Cipher_CBC(unittest.TestCase):

    def test_1(self):
        key = b'\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f'
        iv = b'\xf6\xfaS\x80\xd4\x8d\xc6\x0fz-F*\x06<\x0bS'
        plaintext = b'\x00\x11"3DUfw\x88\x99\xaa\xbb\xcc\xdd\xee\xff\x00\x11"3DUfw\x88\x99\xaa\xbb\xcc\xdd\xee\xff'
        ciphertext = b']\xe3yN\x97\xbb>\x81\x13\xd5\xa1\xcf?\xb4\x05NO\t\x88\x166\x92\xb0\x00\x8e\x99\xac\xdf\xfev\xbcy'
        new_ciphertext = uoc_aes_cbc_cipher(plaintext, key, iv)
        self.assertEqual(new_ciphertext, ciphertext)

    def test_2(self):
        key = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        iv = b'\xdf\x86\xfc\xf9\xc8\xa1\x8a\xd7c\xa8eh\xa5\xe5\xb0\xd2'
        plaintext = b'\x00\x11"3DUfw\x88\x99\xaa\xbb\xcc\xdd\xee\xff\x00\x11"3DUfw\x88\x99\xaa\xbb\xcc\xdd\xee\xff'
        ciphertext = b'\n\xbc4\x13\xa4\x06\xcc\xe5Zh\xa94}\xf9\xe8\x1a\x1c\x82\x1eH}\x1f^\x06\xffR\xca\r\xc1e\xf4p'
        new_ciphertext = uoc_aes_cbc_cipher(plaintext, key, iv)
        self.assertEqual(new_ciphertext, ciphertext)

    def test_3(self):
        key = b'\x0a\x0b\x0c\x0d\x0e\x0f\x0a\x0b\x0c\x0d\x0e\x0f\x00\x00\x00\x00'
        iv = b'u:\xbe\x82\xd9a\x84\x14H\x0c\xecf\xc0\xbf\xdd{'
        plaintext = b'\x00\x11"3DUfw\x88\x99\xaa\xbb\xcc\xdd\xee\xff\x00\x11"3DUfw\x88\x99\xaa\xbb\xcc\xdd\xee\xff'
        ciphertext = b'\x19\x96Xa)\xd8q\x83\xc2\xe3\x9d\x9fS\xc8\xe6i\x1f\xa1\xa8\xd2\x11>\xde\xe5\xeaX\x18\xf1\x84\xf7\xa9\xa5'
        new_ciphertext = uoc_aes_cbc_cipher(plaintext, key, iv)
        self.assertEqual(new_ciphertext, ciphertext)

    def test_4(self):
        key = b'\x0a\x0b\x0c\x0d\x0e\x0f\x0a\x0b\x0c\x0d\x0e\x0f\x00\x00\x00\x00'
        iv = b'I4\xd0\xc8\xca\x94\xf0\x03x\x0c^\xa7 &5\x85'
        plaintext = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        ciphertext = b'\x8e\x9b\xa4JKK\xd9`\xf50B\x0c\xfc\xa9\xf3\xbb\xfa\xf9\x83,\xd3\xd7r}\n\xc1;\xad\xe8\xd8\x80\x9f'
        new_ciphertext = uoc_aes_cbc_cipher(plaintext, key, iv)
        self.assertEqual(new_ciphertext, ciphertext)
...
class Test_2_4_Decipher_CBC(unittest.TestCase):
    ...
    def test_1(self):
        ...
        plaintext = b'\x00\x11"3DUfw\x88\x99\xaa\xbb\xcc\xdd\xee\xff\x00\x11"3DUfw\x88\x99\xaa\xbb\xcc\xdd\xee\xff'
        ciphertext = b']\xe3yN\x97\xbb>\x81\x13\xd5\xa1\xcf?\xb4\x05NO\t\x88\x166\x92\xb0\x00\x8e\x99\xac\xdf\xfev\xbcy'
        new_plaintext = uoc_aes_cbc_decipher(ciphertext, key, iv)
